  ...
  useEffect(() => {
    const checkAuthStatus = async () => {
      ...
      try {
        ...
        // User is authenticated and not banned, fetch posts
        fetchPosts();
      } catch (error) {
  ...
  const fetchPosts = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Transform the data to match our Post interface if needed
        const formattedPosts = data.map((post: any) => ({
          ...
          author: {
            ...
            headline: post.author.headline || 'User',
      ...
      if (response.ok) {
        ...
        const formattedPost: Post = {
          ...
          author: {
            ...
            headline: createdPost.author.headline || currentUser?.headline || 'User',
            avatar: createdPost.author.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(createdPost.author.name)}&background=random`
          },
